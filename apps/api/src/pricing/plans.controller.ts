...
import { CreatePlanDto, UpdatePlanDto } from './pricing.dto';
...
export class PlansController {
  ...
  async getPublicPlans(@Req() req: Request, @Ip() ip: string) {
    ...
    return this.pricingService.getLocalizedPlans(countryCode);
  }
  ...
  @Get('all')
  @ApiOperation({
    summary: 'Fetch all plans with raw tier prices (Admin only)',
  })
  async getAllPlans() {
