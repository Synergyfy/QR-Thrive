...
const FILE_CONFIG = {
  image: { maxSize: 10 * 1024 * 1024, extensions: ['jpg', 'jpeg', 'png', 'gif', 'webp'] },
  video: { maxSize: 50 * 1024 * 1024, extensions: ['mp4', 'mov', 'webm', 'avi'] },
  audio: { maxSize: 50 * 1024 * 1024, extensions: ['mp3', 'wav', 'ogg', 'm4a'] },
  pdf: { maxSize: 20 * 1024 * 1024, extensions: ['pdf'] },
  logo: { maxSize: 5 * 1024 * 1024, extensions: ['jpg', 'jpeg', 'png', 'gif', 'webp', 'svg'] },
};
...
export class UploadService {
  ...
  async uploadFile(
    ...
    const resourceType = fileType === 'image' || fileType === 'logo' ? 'image' : 'raw';
  ...
  async getSignedUploadUrl(
    ...
    const resourceType = fileType === 'image' || fileType === 'logo' ? 'image' : 'auto';
